...
if sys.argv[2] == 'mnistm':
    ...
    cnn.load_state_dict(t.load(os.path.join(opt.ckpts_root, 'mnistm/e49.ckpt')))
    classifier.load_state_dict(t.load(os.path.join(opt.ckpts_root, 'mnistm/classifier.ckpt')))
    ...
    cnn.load_state_dict(t.load(os.path.join(opt.ckpts_root, 'svhn/e0.ckpt')))
    classifier.load_state_dict(t.load(os.path.join(opt.ckpts_root, 'svhn/classifier.ckpt')))
    ...
    cnn.load_state_dict(t.load(os.path.join(opt.ckpts_root, 'usps/e4.ckpt')))
    classifier.load_state_dict(t.load(os.path.join(opt.ckpts_root, 'usps/classifier.ckpt')))
